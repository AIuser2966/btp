"""What should this month's SIP instalment buy?
    ...
    python recommend.py --amount 10000
    python recommend.py --currency INR --amount 10000 --holdings 250000 180000 120000
    python recommend.py --amount 10000 --model Ridge
...
from sip.engine import _smart_split
from sip.optimize import max_sharpe, max_sharpe_mu, risk_parity
...
def main():
    ...
    p.add_argument("--model", default="none", choices=["none", *fc.MODELS],
                   help="use an ML return forecast in the max-Sharpe half")
