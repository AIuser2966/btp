"""Compare all six strategies side by side and write tables + charts to ``results/<currency>/``.

    python 07_comparison/run.py                 # USD investor
    python 07_comparison/run.py --currency INR  # Indian investor, rupee SIP
